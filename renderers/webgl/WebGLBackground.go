...
func NewWebGLBackground(renderer *Renderer, cubemaps *CubeMaps, cubeuvmaps *CubeUVMaps, state *State, objects *Objects, alpha bool, premultipliedAlpha bool) *Background {
	this := &Background{}
	//todo
