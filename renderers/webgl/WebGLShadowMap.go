...
func NewWebGLShadowMap(renderer *Renderer, objects *Objects, capabilities *Capabilities) *ShadowMap {
	this := &ShadowMap{renderer: renderer, objects: objects, capabilities: capabilities}
	//todo
