...
func NewPerspectiveCamera(fov, aspect, near, far float64) *PerspectiveCamera {
	...
	// 		this.far = far; todo
	// 		this.focus = 10; todo
	// 		this.aspect = aspect; todo
	// 		this.view = null; todo
	// 		this.filmGauge = 35;	// width of the film (default in millimeters) todo
	// 		this.filmOffset = 0;	// horizontal film offset (same unit as gauge) todo
	// 		this.updateProjectionMatrix(); todo
	return this
}
